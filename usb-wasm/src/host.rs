...
use crate::component::usb::types::{ControlSetupRecipient, ControlSetupType};

fn host_control_setup_to_rusb(
    setup: &crate::component::usb::device::ControlSetup,
) -> crate::ControlSetup {
    ...
    fn read_bulk(
        ...
        let address = ep.descriptor.endpoint_number
            + match ep.descriptor.direction {
                crate::component::usb::types::Direction::Out => 0x00,
                crate::component::usb::types::Direction::In => 0x80,
            };
        let device = table.get_mut(&rep)?;
